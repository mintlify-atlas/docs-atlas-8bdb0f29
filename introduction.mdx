---
title: "BuzzTrip: Custom Mapping Platform Overview"
sidebarTitle: "Introduction"
description: "BuzzTrip is an open-source collaborative mapping platform for creating, customizing, and sharing maps with real-time collaboration and rich annotation tools."
---
...
- **Add markers** — drop a pin anywhere on the map or tap a point of interest to pull in rich place data from Google Maps, Mapbox, or Foursquare.
...
- **Rich place data** — search and pull POI details from Google Maps, Mapbox, and Foursquare directly into your markers.

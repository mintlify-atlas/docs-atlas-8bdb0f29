...
sidebarTitle: "Schema"
description: "Complete reference for BuzzTrip Convex database tables, fields, indexes, and TypeScript types. Covers maps, markers, collections, places, users, and more."
---

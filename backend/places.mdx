---
title: "Places API: Location Data and Geospatial Indexing"
sidebarTitle: "Places"
...
<ParamField body="photos" type="string[]">
  Array of photo URL strings. Initially populated from the provider (Google Maps, Foursquare). Additional user-submitted photos are stored separately in the `place_photos` table.
</ParamField>

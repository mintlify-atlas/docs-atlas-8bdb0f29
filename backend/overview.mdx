...
description: "BuzzTrip's Convex backend exposes typed queries and mutations for every map operation. Learn how auth, real-time subscriptions, and package exports work."
---

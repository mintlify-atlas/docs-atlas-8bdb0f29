---
title: "Maps: Create and Manage Custom Map Projects in BuzzTrip"
sidebarTitle: "Maps"
...
BuzzTrip tracks map views for analytics via the `trackMapView` mutation. View history is queryable via `getMapViews` for maps you own, giving you insight into how often and from where your maps are being accessed.

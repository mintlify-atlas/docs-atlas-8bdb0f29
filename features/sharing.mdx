---
title: "Share and Collaborate on Maps in Real Time"
...
| Role | Update Map | Manage Content | Delete Map | Manage Users |
|---|---|---|---|---|
| **owner** | ✅ | ✅ | ✅ | ✅ (all users) |
| **editor** | ✅ | ✅ | ❌ | ✅ (non-owners only) |
| **viewer** | ❌ | ❌ | ❌ | ❌ |
| **commenter** | ❌ | ❌ | ❌ | ❌ |
...
<Accordion title="Detailed role permissions">
  **Owner**
  ...
  - Can remove any collaborator including other editors (`map_users:delete`)

  **Editor**
  - Can update map metadata (`maps:update`)
  - Can create and update `map_users` entries (but cannot delete the owner's entry)
  - Can create, update, and delete: markers, collections, collection links, labels, paths, routes, route stops

  **Viewer**
  - Read-only access. Cannot create, edit, or delete any content.

  **Commenter**
  - Read-only access. Commenting is a planned feature — this role is reserved for future use.
</Accordion>
